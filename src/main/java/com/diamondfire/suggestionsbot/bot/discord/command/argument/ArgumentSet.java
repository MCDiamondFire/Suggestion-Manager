package com.diamondfire.suggestionsbot.bot.discord.command.argument;


import com.diamondfire.suggestionsbot.bot.discord.command.argument.impl.parsing.ArgumentNode;
