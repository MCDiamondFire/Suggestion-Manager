...
import com.diamondfire.suggestionsbot.bot.discord.command.argument.impl.types.DefinedObjectArgument;
...
import com.diamondfire.suggestionsbot.bot.discord.command.permissions.*;
import com.diamondfire.suggestionsbot.bot.discord.events.CommandEvent;
import com.diamondfire.suggestionsbot.sys.reactions.multiselector.MultiSelectorBuilder;
...
public class HelpCommand extends Command {
    ...
    public ArgumentSet compileArguments() {
        return new ArgumentSet().addArgument("help",
                new SingleArgumentContainer<>(new DefinedObjectArgument<>(DiscordInstance.getHandler().getCommands().values().stream()
                        .map(Command::getName)
    ...
    public void run(CommandEvent event) {
        ...
        if (helpInfo == null) {
            ...
            List<Command> commandList = new ArrayList<>(DiscordInstance.getHandler().getCommands().values());
            ...
            Command command = DiscordInstance.getHandler().getCommands().get(helpInfo);
            HelpContext context = command.getHelpContext();
